...
namespace lexicon_university.Persistance.Migrations
{
    ...
    [Migration("20241109193223_CourseEnrollment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lexicon_university.Core.Entities.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lexicon_university.Core.Entities.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("CourseStudent", b =>
                {
                    b.HasOne("lexicon_university.Core.Entities.Course", null)
                        .WithMany()
                        .HasForeignKey("CoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("lexicon_university.Core.Entities.Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("lexicon_university.Core.Entities.Enrollment", b =>
                {
                    b.HasOne("lexicon_university.Core.Entities.Course", "Course")
